...
def check_exercise(filename):
	...
	v = ExerciseChecker()
	v.visit(ast)
	if v.number_of_for_loops != 3:
		errors.append("Das Programm sollte genau drei for-Schleifen enthalten.")
	if v.number_of_while_loops != 0:
		errors.append("Das Programm sollte keine while-Schleifen enthalten.")
